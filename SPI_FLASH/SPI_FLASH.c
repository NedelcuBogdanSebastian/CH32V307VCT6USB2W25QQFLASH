...
/*******************************************************************************
* Function Name  : FLASH_ReadJEDECID
* Description    : Read FLASH JEDEC ID
* Input          : None
* Output         : None
* Return         : chip id
*******************************************************************************/
...
/*******************************************************************************
* Function Name  : FLASH_ReadUNIQUEID
* Description    : Read FLASH UNIQUE ID
* Input          : None
* Output         : None
* Return         : unique chip id
*******************************************************************************/
uint32_t FLASH_ReadUNIQUEID( void )
{
    uint32_t dat;
    PIN_FLASH_CS_LOW( );
    SPI_FLASH_SendByte( CMD_FLASH_JEDEC_ID );
...
void FLASH_IC_Check( void )
{
    ...
    /* Read FLASH ID */    
    Flash_ID = FLASH_ReadJEDECID( );
    printf("Flash_JEDEC_ID: %08x\n",(uint32_t)Flash_ID);
